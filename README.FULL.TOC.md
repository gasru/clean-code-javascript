<!--ts-->
  ...
  * [<strong>Переменные</strong>](#переменные)
    ...
    * [Используйте пдходящие для поиска имена](#используйте-пдходящие-для-поиска-имена)
  ...
  * [<strong>Функции</strong>](#функции)
    ...
    * [Удалить мертвый код](#удалить-мертвый-код)
  * [<strong>Objects and Data Structures</strong>](#objects-and-data-structures)
...
### Используйте пдходящие для поиска имена
